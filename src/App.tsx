    ...
    <BrowserRouter>
      ...
      <div className="relative min-h-screen">
        ...
        <a
          ...
          className="fixed bottom-20 right-6 z-50 flex items-center justify-center w-12 h-12 bg-[#25D366] text-white rounded-full shadow-lg hover:bg-[#1DA851] hover:scale-110 transition-all"
        >
